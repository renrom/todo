...
export function leftPanelAvatar() {
...
export function leftPanelProject() {
...
export function leftPanelTodoMenu() {
...
export function leftPanelProjects(projects) {
